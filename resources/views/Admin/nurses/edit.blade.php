...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
      <h3 class="content-header-title">nurse </h3>
      <div class="row breadcrumbs-top">
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('Admin') }}">Admin</a>
            </li>
             <li class="breadcrumb-item"><a href="{{ route('Nurses.index') }}">nurse </a>
            </li>
            <li class="breadcrumb-item active">nurse  Edit
            </li>
          </ol>
        </div>
      </div>
    ...
    <div class="card-body">
      ...
      <div class="tab-content px-1 pt-1">
        <div role="tabpanel" class="tab-pane active" id="tab11" aria-expanded="true" aria-labelledby="base-tab11">
            <form class="form" method="POST" action="{{ route('Nurses.update',$nurse->id) }}">
                @csrf
                @method('put')
                <div class="form-body">
                  <h4 class="form-section">General nurse Info</h4>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="email" id="projectinput1" class="form-control" placeholder="email" name="email" value="{{ $nurse->email }}">
                        @error('email')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="projectinput2" class="form-control" placeholder="Name" name="name" value="{{  $nurse->name }}">
                        </div>
                          @error("name")
                          <span class="text-danger"> {{$message}}</span>
                          @enderror
                                ...
                                <optgroup label="من فضلك أختر القسم ">
                                    ...
                                    @if($Shifts && $Shifts -> count() > 0)
                                        @foreach($Shifts as $Shift)
                                            <option
                                            {{ ($nurse->shift_id == $Shift->id) ? "selected" : ''}}
