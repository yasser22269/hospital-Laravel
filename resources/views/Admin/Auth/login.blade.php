               ...
               @include('Admin.layouts.alerts.alerts')
                  ...
                  <div class="card-body pt-0">
                    ...
                    <form class="form-horizontal" action="{{ route('admin.post.login') }}" method="POST">
                      ...
                      <fieldset class="form-group floating-label-form-group mb-1">
                        <label for="user-password">Type</label>
                        <select name="type_id" class="form-control">
                            <option value="manger">Manger</option>
                            <option value="doctor">doctor</option>
                            <option value="nurse">nurse</option>
                        </select>
                        {{-- <input type="radio" class="form-control" name="type_id"> Manger
                        <input type="radio" class="form-control" name="type_id"> Doctor
                        <input type="radio" class="form-control" name="type_id"> Nurse --}}
                        @error('type_id')
                                     <span class="text-danger">{{$message}}</span>
                        @enderror
                      </fieldset>
